...
Reference:
    ...
    Appendix D - Bayless J. and P. Somerville (2024, updated May 11, 2026). 
    AECOM internal report. 

Revision:
    April 2026 (Rev1): Initial implementation.
    May 2026   (Rev2): Updated depth scaling model and coefficients
                       following personal communication with Jeff Bayless:
                       - fZtor: Z = min(Ztor-10, 5) replacing Z = min(Ztor, 20)
                       - Model centred at Ztor=10 km (d4 fixed to zero)
                       - Updated a1 (Cratonic and NonCratonic), d1, d2, d3
                         from revised Table D-7 (BS24 Appendix Rev2, May 2026)
===========================================================================
