...
```
- `gmm/bayless_somerville_2024.py` — the GMM implementation
- `tests/bayless_somerville_2024_test.py` — GEM-format verification test module
- `tests/data/BS24_CRATONIC.csv` — GEM verification data (Cratonic)
- `tests/data/BS24_NONCRATONIC.csv` — GEM verification data (NonCratonic)

- `tests/test_bayless_somerville_2024.py` — the unit test suite(26 tests)
- `benchmark/bs24_runner.f` — Fortran driver (requires `bs24_gmm.f` from authors)
- `benchmark/benchmark_bs24.py` — benchmark script comparing Fortran and Python versions

- `plots/plot_bs24_spectra_py.py` — response spectra plot from Python GMM
- `plots/plot_bs24_spectra_ft.py` — response spectra plot from Fortran output
- `plots/plot_bs24_comparison.py` — side-by-side Fortran vs Python comparison
