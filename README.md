...
The implementation was verified by direct comparison against the Fortran reference subroutine provided by Jeff Bayless (AECOM), achieving agreement to within floating-point precision across 1760 test cases (max difference 0.000045 ln units on mean SA, 0.000005 ln units on sigma).
